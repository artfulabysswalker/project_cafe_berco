...
Route::put('/admin/password/update', [StaffController::class, 'updateOwnPassword'])
    ->name('admin.password.update');

Route::get('/admin/staff/{id}/password', [StaffController::class, 'editPassword'])
    ->name('admin.staff.password.edit');

Route::put('/admin/staff/{id}/password', [StaffController::class, 'updatePassword'])

    ...
    public function setDiscount(Request $request, $id)
{
    ...
    $menu->update([
        ...
        'discount_start' => now(),
        'discount_end' => now()->addDays($days),
    ]);

    return redirect()->route('admin.menu')
        ->with('success', 'Discount applied!');
}
...
public function discountForm($id)
{
    ...
    return view('admin.menu.discount', compact('menu'));
}
...
public function setDiscount(Request $request, $id)
{
    ...
    $request->validate([
        'discount_price' => 'required|numeric|lt:' . $menu->harga,
        'duration' => 'required|integer'
    ]);

    $menu->discount_price = $request->discount_price;
    $menu->discount_start = now();
    $menu->discount_end = now()->addDays((int)$request->duration);

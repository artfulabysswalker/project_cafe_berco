...
<div class="px-6 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-3xl font-bold text-amber-900">Riwayat Pesanan</h1>
        </div>
        <p class="text-gray-600 ml-14">Lihat semua pesanan yang telah diselesaikan</p>
    </div>
    ...
    @if($orders->isEmpty())
        ...
        <div class="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border-2 border-dashed border-amber-300 p-12 text-center">
            ...
            <h3 class="text-xl font-semibold text-amber-900 mb-2">Tidak Ada Riwayat Pesanan</h3>
            <p class="text-amber-700">Belum ada pesanan yang diselesaikan.</p>
        </div>
    @else
        <!-- Orders Table -->
        <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
            ...
            <div class="bg-gradient-to-r from-amber-50 to-amber-100 px-6 py-4 border-t border-gray-200">
                <p class="text-sm text-gray-600">
                    <strong class="text-amber-900">Total:</strong> {{ count($orders) }} pesanan
                </p>
            </div>
        </div>

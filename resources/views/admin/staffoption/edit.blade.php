            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('status') is-invalid @enderror" id="status" name="status">
                        <option value="active" {{ old('status', $staff->status ?? 'active') === 'active' ? 'selected' : '' }}>Aktif (Dapat Login)</option>
                        <option value="inactive" {{ old('status', $staff->status ?? 'active') === 'inactive' ? 'selected' : '' }}>Nonaktif (Tidak Dapat Login)</option>
                    </select>
                    @error('status')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror

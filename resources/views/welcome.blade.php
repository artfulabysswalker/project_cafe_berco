        ...
        <div class="container header-container">
            ...
            <nav class="nav">
                <ul>
                    ...
                    <li><a href="{{ route('menu') }}"><i class="fas fa-mug-hot"></i> Menu</a></li>
                    <li><a href="{{ route('cart') }}"><i class="fas fa-shopping-cart"></i> Keranjang</a></li>
                </ul>
            </nav>
            <div class="user-action">
                @auth
                    <span style="color:white; margin-right: 12px;">Halo, {{ auth()->user()->name }}</span>
    ...
    <section class="hero">
        ...
        <div class="container hero-container">
            ...
            <div class="hero-btns">
                ...
                <a href="{{ route('menu') }}" class="btn btn-secondary">Lihat Menu</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="contact-grid">
                <div class="contact-card">
                    ...
                    <h3>Lokasi</h3>
                    <p>Jl. SMA Negeri 1, Krajan, Purwoharjo, Kec. Purwoharjo, Kabupaten Banyuwangi, Jawa Timur 68483, Indonesia</p>
                </div>
                <div class="contact-card">
                ...
                <div class="contact-card">
                    ...
                    <p>Buka setiap hari mulai pukul 16.00 hingga 22.00 WIB</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container footer-container">
            ...
            <div class="footer-links">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('menu') }}">Gallery</a></li>

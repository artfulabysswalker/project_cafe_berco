...
'roles'
    ...
    {
        $roles = Role::all(); // get roles for dropdown
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.staffoption.index')->with('success', 'Staff account created successfully.');
    }
    ...
    public function update(Request $request, $id_user)
    {
        ...
        return redirect()->route('admin.staffoption.index')->with('success', 'Staff account updated successfully.');
    }
    ...
    public function toggleStatus($id_user)
    {
        ...
        // Add a 'status' column in your users table if you want this
        $staff->status = $staff->status === 'active' ? 'inactive' : 'active';
        $staff->save();

        return redirect()->route('admin.staffoption.index')->with('success', 'Staff status updated successfully.');
    }
